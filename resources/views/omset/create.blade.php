        ...
        <div class="col-sm-5 mb-3 mb-sm-0">
            ...
            <div class="form-group">
                ...
                <input type="number" name="biaya_mobil"
                    ...
                    placeholder="Biaya/1 Mobil" value="{{ old('biaya_mobil') }}">
                @error('biaya_mobil')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input type="number" name="pengeluaran_jkt"
                    ...
                    id="pengeluaran_jkt" placeholder="Pengeluaran JKT" value="{{ old('pengeluaran_jkt') }}">
            ...
            <div class="form-group">
                ...
                <input type="number" name="pengeluaran_lpg"
                    ...
                    id="pengeluaran_lpg" placeholder="Pengeluaran LPG" value="{{ old('pengeluaran_lpg') }}">
            ...
            <div class="form-group">
                ...
                <input type="number" readonly name="jumlah_omset_bersih" class="form-control form-control-user @error('jumlah_omset_bersih') is-invalid @enderror"
                    id="jumlah_omset_bersih" placeholder="Jumlah Rp." value="{{ old('jumlah_omset_bersih') }}">
